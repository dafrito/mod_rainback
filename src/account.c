...
void rainback_generateAccountPage(rainback_Page* page, mod_rainback* rb, const char* pageState, parsegraph_user_login* login)
{
    char body[8192];
...
"</html>",
    ...
    len = snprintf(buf, sizeof buf,
        ...
        "\r\n",
        bodylen,
        parsegraph_constructSessionString(rb->pool,
